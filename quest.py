...
def general():
    ...
    def parse(string):
        ...
        try:
            ...
            for sentence in txt.sentences:
                ...
                li.append(genQuestion(sentence))
                a=set(li)
                b=list(a)
            return b
    ...
    def genQuestion(line):
        """
        outputs question fhttps://towardsdatascience.com/flask-and-heroku-for-online-machine-learning-deployment-425beb54a274rom the given text
        """
    ...
    return jsonify(parse(textinput))
